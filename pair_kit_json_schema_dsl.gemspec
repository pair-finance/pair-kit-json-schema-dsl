require File.expand_path('lib/pair_kit/json_schema/dsl/version', __dir__)

Gem::Specification.new do |spec|
  spec.name                  = 'pair-kit-json-schema-dsl'
  spec.version               = PairKit::JsonSchema::Dsl::VERSION
  spec.authors               = ['Dmitry Sharkov']
  spec.email                 = %w(dmitry.sharkov@gmail.com dmitry.sharkov@pairfinance.com)
  spec.summary               = 'Ruby DSL to build Json Schemas'
  spec.description           = 'This gem helps to build JSON schemas'
  spec.homepage              = 'https://github.com/pair-finance/pair_kit_json_schemas_dsl'
  spec.license               = 'MIT'
